...
resource "google_compute_instance" "mynet-eu-vm-1" {
  boot_disk {
    auto_delete = true
    device_name = "mynet-eu-vm"
  ...
  network_interface {
    ...
    subnetwork = "projects/group-work-387811/regions/europe-west1/subnetworks/mynetwork-europe-west1"
  }
